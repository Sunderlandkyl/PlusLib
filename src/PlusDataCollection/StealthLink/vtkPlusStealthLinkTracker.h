...
#ifndef __vtkPlusStealthLinkTracker_h
#define __vtkPlusStealthLinkTracker_h
...
class vtkPlusDataCollectionExport vtkPlusStealthLinkTracker : public vtkPlusDevice
{
public:
