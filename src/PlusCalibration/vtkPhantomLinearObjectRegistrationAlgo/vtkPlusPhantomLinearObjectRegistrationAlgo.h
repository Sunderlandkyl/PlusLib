...
#ifndef __vtkPlusPhantomLinearObjectRegistrationAlgo_h
#define __vtkPlusPhantomLinearObjectRegistrationAlgo_h
...
*/
class vtkPlusCalibrationExport vtkPlusPhantomLinearObjectRegistrationAlgo : public vtkObject
{
public:
  vtkTypeMacro(vtkPlusPhantomLinearObjectRegistrationAlgo,vtkObject);
  static vtkPlusPhantomLinearObjectRegistrationAlgo *New();
...
public:
  ...
  */
  ...
  static std::string GetConfigurationElementName() { return vtkPlusPhantomLinearObjectRegistrationAlgo::ConfigurationElementName; };
