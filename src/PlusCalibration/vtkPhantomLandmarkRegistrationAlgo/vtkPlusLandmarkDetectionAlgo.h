...
*/
class vtkPlusCalibrationExport vtkPlusLandmarkDetectionAlgo : public vtkObject
{
public:
  vtkTypeMacro( vtkPlusLandmarkDetectionAlgo, vtkObject );
...
protected:
  ...
  */
  PlusStatus ComputeFilterWindowSize( unsigned int& filterWindowSize );
  ...
  */
  PlusStatus ComputeNumberOfWindows( unsigned int& numberOfWindows );
