...
protected:
  ...
  //TODO
  PlusStatus InitializeTracks();
  PlusStatus ConvertBitstreamToTrackedFrame(unsigned char* bitstream, long bistreamSize, vtkImageData* outputYUVImage, vtkImageData* outputRGBImage, PlusTrackedFrame* outputTrackedFrame);
...
private:
  ...
  igtl::SmartPointer<igtl::GenericEncoder> Encoder;
  ...
  vtkSmartPointer<vtkImageMapToColors> RGBToGreyScaleFilter;

  double FrameRate;
  igtl::SmartPointer<igtl::GenericDecoder> Decoder;
